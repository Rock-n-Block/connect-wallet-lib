...
var ConnectWallet = /** @class */ (function () {
    ...
    function ConnectWallet(initProvider) {
        ...
        this.use = function (wallets) {
            ...
            _this.availableProviders = wallets.map(function (wallets) { return wallets.name; });
            return _this;
        };
        /**
    ...
    ConnectWallet.prototype.connect = function (provider, network, settings, keys) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(0, utils_1.isConfigSufficient)(networkConfig).ok) {
                ...
                return [2 /*return*/, this.connector
                        ...
                        if (connect.connected) {
                            if (connect.provider.chainId === networkConfig.chainID) {
                                _this.initWeb3(connect.provider === "Web3"
    ...
    ConnectWallet.prototype.chooseProvider = function (name) {
        ...
        var provider = this.connectors.find(function (connector) { return connector.name === name; });
            ...
            if (_this.currentWeb3() && !_this.connector) {
                ...
                _this.connector.getAccounts().then(function (connectInfo) {
                    if (connectInfo.network.chainID !== chainID_1) {
                        reject(_this.applySettings((0, errors_1.chainError)("Please set network: ".concat(chainsMap_1[chainIDMap_1[chainID_1]].name, "."))));
                    }
                    else {
