...
var web3_provider_1 = __importDefault(
                  ...
                  case 0:
                    ...
                    return [
                      ...
                      web3_provider_1.EthereumProvider.init({
                        projectId:
                          provider.provider[provider.useProvider].projectId,
                        chains: provider.provider[provider.useProvider].chains,
                        showQrModal:
                          provider.provider[provider.useProvider].showQrModal,
                      }).then((provider) =>
                        provider
                          .connect()
                          .then(function () {
    ...
    return new rxjs_1.Observable(function (observer) {
      ...
      _this.connector.on('accountsChanged', function (accounts, payload) {
        ...
        observer.next({
          address: accounts[0],
          network:
            helpers_1.parameters.chainsMap[
              helpers_1.parameters.chainIDMap[_this.connector.chainId]
            ],
